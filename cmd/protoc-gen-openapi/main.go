...
func main() {
	conf := generator.Configuration{
		...
		PriorityComment: flags.Bool("priority_comment", false, `is or not service name and function name display comment. If "true" service name and function name display comment`),
	}
