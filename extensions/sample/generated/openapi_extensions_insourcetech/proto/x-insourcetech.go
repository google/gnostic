...
func NewInSourceBook(in interface{}, context *compiler.Context) (*InSourceBook, error) {
	errors := make([]error, 0)
	x := &InSourceBook{}
...
func NewInSourceShelve(in interface{}, context *compiler.Context) (*InSourceShelve, error) {
	errors := make([]error, 0)
	x := &InSourceShelve{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
...
func (m *InSourceBook) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	return nil, compiler.NewErrorGroupOrNil(errors)
}

func (m *InSourceShelve) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	return nil, compiler.NewErrorGroupOrNil(errors)
}
