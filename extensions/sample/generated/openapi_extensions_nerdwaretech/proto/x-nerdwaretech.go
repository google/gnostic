...
func NewNerdwareBook(in interface{}, context *compiler.Context) (*NerdwareBook, error) {
	errors := make([]error, 0)
	x := &NerdwareBook{}
...
func NewNerdwareShelve(in interface{}, context *compiler.Context) (*NerdwareShelve, error) {
	errors := make([]error, 0)
	x := &NerdwareShelve{}
	m, ok := compiler.UnpackMap(in)
	if !ok {
...
func (m *NerdwareBook) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	return nil, compiler.NewErrorGroupOrNil(errors)
}

func (m *NerdwareShelve) ResolveReferences(root string) (interface{}, error) {
	errors := make([]error, 0)
	return nil, compiler.NewErrorGroupOrNil(errors)
}
