...
const file_surface_surface_proto_rawDesc = "" +
	"\n" +
	"\x15surface/surface.proto\x12\n" +
	"surface.v1\"\xca\x02\n" +
	"\x05Field\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04type\x18\x02 \x01(\tR\x04type\x12)\n" +
	"\x04kind\x18\x03 \x01(\x0e2\x15.surface.v1.FieldKindR\x04kind\x12\x16\n" +
	"\x06format\x18\x04 \x01(\tR\x06format\x120\n" +
	"\bposition\x18\x05 \x01(\x0e2\x14.surface.v1.PositionR\bposition\x12\x1f\n" +
	"\vnative_type\x18\x06 \x01(\tR\n" +
	"nativeType\x12\x1d\n" +
	"\n" +
	"field_name\x18\a \x01(\tR\tfieldName\x12%\n" +
	"\x0eparameter_name\x18\b \x01(\tR\rparameterName\x12\x1c\n" +
	"\tserialize\x18\t \x01(\bR\tserialize\x12\x1f\n" +
	"\venum_values\x18\n" +
	" \x03(\tR\n" +
	"enumValues\"\xd1\x01\n" +
	"\x04Type\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12(\n" +
	"\x04kind\x18\x02 \x01(\x0e2\x14.surface.v1.TypeKindR\x04kind\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12!\n" +
	"\fcontent_type\x18\x04 \x01(\tR\vcontentType\x12)\n" +
	"\x06fields\x18\x05 \x03(\v2\x11.surface.v1.FieldR\x06fields\x12\x1b\n" +
	"\ttype_name\x18\x06 \x01(\tR\btypeName\"\xd5\x02\n" +
	"\x06Method\x12\x1c\n" +
	...
	"\fhandler_name\x18\x06 \x01(\tR\vhandlerName\x12%\n" +
	"\x0eprocessor_name\x18\a \x01(\tR\rprocessorName\x12\x1f\n" +
	"\vclient_name\x18\b \x01(\tR\n" +
	"clientName\x120\n" +
	"\x14parameters_type_name\x18\t \x01(\tR\x12parametersTypeName\x12.\n" +
	"\x13responses_type_name\x18\n" +
	" \x01(\tR\x11responsesTypeName\"\xa2\x01\n" +
	"\x05Model\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12&\n" +
	"\x05types\x18\x02 \x03(\v2\x10.surface.v1.TypeR\x05types\x12,\n" +
	"\amethods\x18\x03 \x03(\v2\x12.surface.v1.MethodR\amethods\x12/\n" +
	"\x13symbolic_references\x18\x04 \x03(\tR\x12symbolicReferences*C\n" +
	"\tFieldKind\x12\n" +
	"\n" +
	"\x06SCALAR\x10\x00\x12\a\n" +
	"\x03MAP\x10\x01\x12\t\n" +
	"\x05ARRAY\x10\x02\x12\r\n" +
	"\tREFERENCE\x10\x03\x12\a\n" +
	"\x03ANY\x10\x04*\"\n" +
	"\bTypeKind\x12\n" +
	"\n" +
	...
	"\bFORMDATA\x10\x02\x12\t\n" +
	"\x05QUERY\x10\x03\x12\b\n" +
	"\x04PATH\x10\x04B\x16Z\x14./surface;surface_v1b\x06proto3"

var (
	file_surface_surface_proto_rawDescOnce sync.Once
	file_surface_surface_proto_rawDescData []byte
)

func file_surface_surface_proto_rawDescGZIP() []byte {
	file_surface_surface_proto_rawDescOnce.Do(func() {
		file_surface_surface_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_surface_surface_proto_rawDesc), len(file_surface_surface_proto_rawDesc)))
	})
...
var file_surface_surface_proto_goTypes = []any{
...
func file_surface_surface_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_surface_surface_proto_rawDesc), len(file_surface_surface_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
